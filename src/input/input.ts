export class Input {
 keys=new Set<string>();pressed=new Set<string>();mouseX=0;mouseY=0;pointerX=innerWidth/2;pointerY=innerHeight/2;looking=false;enabled=false;spark=false;
 constructor(canvas:HTMLCanvasElement){
  ...
  window.addEventListener('pointermove',e=>{this.pointerX=e.clientX;this.pointerY=e.clientY;if(this.enabled&&(this.looking||document.pointerLockElement===canvas)){this.mouseX+=e.movementX;this.mouseY+=e.movementY;}});
 }
